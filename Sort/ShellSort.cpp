...
const int SORTING_SPEED_DIVISOR = 40; // Changed from 4 to 40

int main(){
    sf::RenderWindow window(sf::VideoMode(WINDOW_WIDTH, WINDOW_HEIGHT), "Shell Sort Visualization");
